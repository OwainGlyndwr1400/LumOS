...
@register(
    name="search_memory",
    description=(
        "Search Lumos's identity memory (lived conversation history with Erydir) for "
...
@register(
    ...
    description=(
        ...
        "relevant entries. CALL THIS when the question is about Erydir's research "
...
def cite_source(chunk_id: str) -> dict:
    ...
    if lane == "identity":
        ...
        citation = f'"{title}" — Erydir + Lumos conversation, {date_first}'
